...
url.searchParams.set('pagesource', "tutorial/datastructures.rst");
...
# 5. Data Structures[Â¶](#data-structures "Link to this heading")

This chapter describes some things youâve learned about already in more detail,
and adds some new things as well.

## 5.1. More on Lists[Â¶](#more-on-lists "Link to this heading")
...
### 5.1.1. Using Lists as Stacks[Â¶](#using-lists-as-stacks "Link to this heading")
...
### 5.1.2. Using Lists as Queues[Â¶](#using-lists-as-queues "Link to this heading")
...
### 5.1.3. List Comprehensions[Â¶](#list-comprehensions "Link to this heading")
...
## 5.2. The `del` statement[Â¶](#the-del-statement "Link to this heading")
...
## 5.3. Tuples and Sequences[Â¶](#tuples-and-sequences "Link to this heading")
...
## 5.4. Sets[Â¶](#sets "Link to this heading")
...
## 5.5. Dictionaries[Â¶](#dictionaries "Link to this heading")
...
## 5.6. Looping Techniques[Â¶](#looping-techniques "Link to this heading")
...
## 5.8. Comparing Sequences and Other Types[Â¶](#comparing-sequences-and-other-types "Link to this heading")
